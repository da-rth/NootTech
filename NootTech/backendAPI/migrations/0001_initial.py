    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('upload_key', models.CharField(default='PEvhlUudRge9lwDd6Gytig==', max_length=26)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('generated_filename', models.CharField(blank=True, max_length=16, null=True, unique=True)),
                ('original_filename', models.CharField(max_length=256)),
                ('file_path', models.FileField(blank=True, null=True, unique=True, upload_to=backendAPI.utils.get_file_path)),
                ('file_ext', models.CharField(default=None, max_length=24)),
                ...
                ('file_type', models.CharField(default='Other', max_length=6)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('embed_type', models.CharField(blank=True, max_length=32)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
