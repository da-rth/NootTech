<template>
  <div id="PrivacyPolicy">
    ...
    <p>NootTech ("us", "we", or "our") operates the <a href="https://noot.tech/">https://noot.tech/</a> website (the
      "Service"). This page informs you of our policies regarding the collection, use, and disclosure of personal data
      when you use our Service and the choices you have associated with that data. Our Privacy Policy for NootTech is
      created with the help of the <a href="https://www.freeprivacypolicy.com/">Free Privacy Policy website</a>. We use
      ...
      Privacy Policy have the same meanings as in our Terms and Conditions, accessible from https://noot.tech/</p>
    ...
    <p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement to
      that transfer.</p>
    <p>NootTech will take all steps reasonably necessary to ensure that your data is treated securely and in accordance
